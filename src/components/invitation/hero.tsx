  ...
  return (
    ...
    >
      ...
      >
        ...
        <blockquote className="mt-5 font-serif text-lg font-light italic leading-relaxed [text-wrap:balance] sm:text-2xl sm:leading-relaxed">
          &ldquo;{wedding.dedication.text}&rdquo;
        </blockquote>
