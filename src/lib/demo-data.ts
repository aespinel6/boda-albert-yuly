...
export const demoGuests: Guest[] = [
  {
    ...
    group: "amigos", allowed_guests: 2, adults: 2, children: 0, party: [{ name: "Carlos Pérez", kind: "adult", attending: true }, { name: "Ana Pérez", kind: "adult", attending: true }], table_name: null, token: "demo-carlos", status: "confirmed",
  ...
  },
  {
    ...
    group: "familia", allowed_guests: 4, adults: 3, children: 1, party: [{ name: "María Gómez", kind: "adult", attending: true }, { name: "Pedro Gómez", kind: "adult", attending: true }, { name: "Luis Gómez", kind: "adult", attending: true }, { name: "Sofi Gómez", kind: "child", attending: true }], table_name: null, token: "demo-maria", status: "pending",
  ...
  },
  {
    ...
    group: "trabajo", allowed_guests: 1, adults: 1, children: 0, party: [{ name: "Andrés Ruiz", kind: "adult", attending: true }], table_name: null, token: "demo-andres", status: "declined",
  ...
  },
  {
    ...
    group: "familia", allowed_guests: 3, adults: 2, children: 1, party: [{ name: "Laura Díaz", kind: "adult", attending: true }, { name: "Jorge Díaz", kind: "adult", attending: true }, { name: "Mati Díaz", kind: "child", attending: true }], table_name: null, token: "demo-laura", status: "confirmed",
  ...
  },
  {
    ...
    group: "amigos", allowed_guests: 2, adults: 2, children: 0, party: [{ name: "Jorge Salas", kind: "adult", attending: true }, { name: "Esposa", kind: "adult", attending: true }], table_name: null, token: "demo-jorge", status: "pending",
