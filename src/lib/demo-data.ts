...
export const demoGuests: Guest[] = [
  {
    ...
    group: "amigos", allowed_guests: 2, adults: 2, children: 0, token: "demo-carlos", status: "confirmed",
  ...
  },
  {
    ...
    group: "familia", allowed_guests: 4, adults: 3, children: 1, token: "demo-maria", status: "pending",
  ...
  },
  {
    ...
    group: "trabajo", allowed_guests: 1, adults: 1, children: 0, token: "demo-andres", status: "declined",
  ...
  },
  {
    ...
    group: "familia", allowed_guests: 3, adults: 2, children: 1, token: "demo-laura", status: "confirmed",
  ...
  },
  {
    ...
    group: "amigos", allowed_guests: 2, adults: 2, children: 0, token: "demo-jorge", status: "pending",
